...
from environments.xplane2 import XPlane11, get_state_sample

action_bounds = [1]

eps = [OUPolicy(0.5, 0.2, 0.4)]
...
TRAIN_NUM = "002"
NAME = "xplane2-train-" + TRAIN_NUM  # Model name
...
def train(env, agent):
    ...
    util = Utils()
    state_samples = get_state_sample(env=env, xpc_client=client, samples=200, normal_state=True)
