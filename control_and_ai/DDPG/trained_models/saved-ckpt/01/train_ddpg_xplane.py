...
NAME = "xplane-train-01"  # Model name
TRAIN_NUM = "20"
...
def train(env, agent):
    ...
    util = Utils()
    state_samples = get_state_sample(env=env, xpc_client=client, samples=160, normal_state=True)
